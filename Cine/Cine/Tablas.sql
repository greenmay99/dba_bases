...
CREATE TABLE Cliente (
	...
	genero_cliente CHAR(1) NOT NULL CHECK(genero_cliente IN ('H', 'M')),
...
CREATE TABLE Proveedor (
	...
	genero_proveedor CHAR(1) NOT NULL CHECK(genero_proveedor IN ('H', 'M')),
...
---- foreign key -----
	nombre_sucursal_empleado VARCHAR (50) NOT NULL
)
...
EXEC InsertarCliente 
	'Carlos', 'Gomez', 'Lopez', 'carlos.gomez@example.com', '5551234567', '1990-05-10', 'H', 
	'Avenida Reforma', '101', 'Juárez', 'Ciudad de México', 'Ciudad de México', '06600';

EXEC InsertarCliente 
	'María', 'Fernandez', 'Soto', 'maria.fernandez@example.com', '5559876543', '1988-08-25', 'M', 
	'Calle Hidalgo', '202', 'Centro', 'Guadalajara', 'Jalisco', '44100';

EXEC InsertarCliente 
	'Luis', 'Hernandez', 'Martinez', 'luis.hernandez@example.com', '5551112233', '1995-12-15', 'H', 
	'Calle Madero', '303', 'Centro', 'Monterrey', 'Nuevo León', '64000';

EXEC InsertarCliente 
	'Ana', 'Ramirez', 'Diaz', 'ana.ramirez@example.com', '5554445566', '1992-03-05', 'M', 
	'Calle Zaragoza', '404', 'Centro', 'Puebla', 'Puebla', '72000';

EXEC InsertarCliente 
	'Jorge', 'Morales', 'Nava', 'jorge.morales@example.com', '5556667788', '1998-09-20', 'H', 
	'Boulevard Belisario Domínguez', '505', 'Centro', 'Tuxtla Gutiérrez', 'Chiapas', '29000';

EXEC InsertarCliente 
	'Lucía', 'Castillo', 'Reyes', 'lucia.castillo@example.com', '5557778899', '1993-11-30', 'M', 
	'Avenida Universidad', '606', 'San Lorenzo', 'Toluca', 'Estado de México', '50100';

EXEC InsertarCliente 
	'Diego', 'Vega', 'Flores', 'diego.vega@example.com', '5558889900', '1997-06-12', 'H', 
	'Calle Juárez', '707', 'Centro', 'Mérida', 'Yucatán', '97000';

EXEC InsertarCliente 
	'Fernanda', 'Cruz', 'Paredes', 'fernanda.cruz@example.com', '5559990011', '1991-02-18', 'M', 
	'Avenida 5 de Febrero', '808', 'Centro Sur', 'Querétaro', 'Querétaro', '76000';

EXEC InsertarCliente 
	'Ricardo', 'Mendez', 'Sanchez', 'ricardo.mendez@example.com', '5551113344', '1989-07-22', 'H', 
	'Boulevard Colosio', '909', 'Industrial', 'Hermosillo', 'Sonora', '83000';

EXEC InsertarCliente 
	'Sofía', 'Ortega', 'Gutiérrez', 'sofia.ortega@example.com', '5552224455', '1996-01-02', 'M', 
